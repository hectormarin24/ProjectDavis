...
export default class bathroomSort extends Phaser.Scene {
    ...
    create() {
        ...
        this.message = this.add
            .text(cx, 50, 'Let toilet paper fall. Swipe other stuff away!', {
                font: '26px Arial',
                color: '#111',
                align: 'center',
    ...
    spawnFallingItem() {
        ...
        // TP falls only above toilet
        let x;
        if (isGood) {
            const spawnMinX = this.bowl.x - 140;
            const spawnMaxX = this.bowl.x + 140;
            x = Phaser.Math.Between(spawnMinX, spawnMaxX);
        } else {
